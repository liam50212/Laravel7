        ...
        <div class="main pt-5 py-5 mb-5">
            <div class="container menu ">
                ...
                <div class="section-bar d-flex position-relative">
                    ...
                    <span class="badge position-absolute text-white"
                        style="left: 500px; background-color:#10B981">3</span>
                    <div class="progress " style="max-width: 180px;width: 180px; height: 10px; left: 560px;">
                        <div class="progress-bar bg-success" role="progressbar" style="width:100%;" aria-valuenow="25"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <span class="badge position-absolute text-white"
                        style="left: 750px; background-color:#10B981">4</span>
                </div>
                ...
                <h4 class="pt-5 ml-5 mb-4">訂單明細</h4>
                <div class="section-food d-flex flex-wrap">
                    <img class="foodimg ml-3" src="./img/chicken momo.jpg" style="width: 60px; height: 60px;" alt="">
                    <div class="food1 d-flex justify-content-between mb-3" style="width: 90%;">
                        <div class="food-text mb-3" style="width: 500px;">
                            <h5>Chicken momo</h5>
                            <span>#41551</span>
                            <hr style="width: 880px;">
                        </div>
                        <div class="price1 d-flex justify-content-center align-items-center">
                            <div class="quantity mr-5">x1</div>
                            <span>$10.50</span>
                        </div>
                    </div>
                    <img class="foodimg ml-3" src="./img/Spicy Mexican potatoes.jpg" style="width: 60px; height: 60px;"
                        alt="">
                    <div class="food1 d-flex justify-content-between mb-3" style="width: 90%;">
                        <div class="food-text  mb-3" style="width: 500px;">
                    ...
                    <img class="foodimg ml-3" src="./img/Breakfast.jpg" style="width: 60px; height: 60px;" alt="">
                    <div class="food1 d-flex justify-content-between mb-3" style="width: 90%;">
                        <div class="food-text  mb-5" style="width: 500px;">
                            <h5>Breakfast</h5>
                            <span>#86577</span>
                        </div>
                        <div class="price1 d-flex justify-content-center align-items-center">
                ...
                <h4 class="ml-5 mb-4">寄送資料</h4>
                <div class="data ml-5">
                    <div class="name mb-4">
                        <span class="mr-5">姓名</span>
                        <span>王曉明</span>
                    </div>
                    <div class="phone mb-4">
                        <span class="mr-5">電話</span>
                ...
                <div class="section-next px-4 mb-5">
                    <div class="next text-right">
                        <a href="./bootstrap-w.html">
                            <button type="button" class="btn btn-primary mb-5">返回首頁</button>
                        </a>
                    </div>
                </div>
            </div>
