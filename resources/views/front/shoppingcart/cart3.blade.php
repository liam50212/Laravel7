    ...
    <main>
        <div class="main pt-5 py-5 mb-5">
            <div class="container menu ">
                ...
                <hr class="mt-5">
                <h2 class="pt-3 ml-5 mb-4">寄送方式</h2>
                <h3 class="ml-5">姓名</h3>
                <input class="ml-5" style="width: 90%;height: 45px;" type="text" name="" id="" placeholder="王小明">
                <h3 class="ml-5">電話</h3>
                <input class="ml-5" style="width: 90%;height: 45px;" type="text" name="" id="" placeholder="0912345678">
                <h3 class="ml-5">Email</h3>
                <input class="ml-5" style="width: 90%;height: 45px;" type="text" name="" id=""
                    placeholder="abc123@gmail.com">
                <h3 class="ml-5">地址</h3>
                <input class="ml-5" style="width: 45%;height: 45px;" type="text" name="" id="" placeholder="城市">
                <input class="" style="width: 44.5%;height: 45px;" type="text" name="" id="" placeholder="郵遞區號"><br>
                <input class="ml-5 mt-2 mb-5" style="width: 90%;height: 45px;" type="text" name="" id=""
                    placeholder="地址">
                <hr style="width: 90%;">
                <div class="total">
